...
export const INSPIRATION_CARDS: InspirationCard[] = [
  ...
  },
  {
    ...
    styleLabel: "Style",
    emoji: "💍",
    gradient: "from-cf-purple-200 via-purple-200 to-fuchsia-200",
  ...
  },
  {
    ...
    styleLabel: "Style",
    emoji: "🦄",
    gradient: "from-sky-300 via-cf-purple-200 to-pink-300",
  ...
  },
  {
    ...
    styleLabel: "Style",
    emoji: "✨",
    gradient: "from-cf-purple-300 via-purple-300 to-fuchsia-300",
  ...
  },
  {
    ...
    styleLabel: "Style",
    emoji: "🎊",
    gradient: "from-cf-purple-400 via-fuchsia-300 to-pink-400",
...
export const MOCK_GENERATED_DESIGNS: GeneratedDesign[] = [
  ...
  },
  {
    ...
    gradient: "from-slate-300 via-cf-purple-200 to-purple-200",
    style: "Minimal",
    liked: false,
...
export const MOCK_BAKERS: Baker[] = [
  {
    ...
    avatarGradient: "from-cf-purple-500 to-indigo-600",
    verified: true,
    badge: "Top Rated",
  },
  {
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  {
    ...
    icon: "💬",
    accent: "from-cf-purple-500 to-purple-500",
  },
  {
    step: 2,
    ...
    icon: "✨",
    accent: "from-purple-500 to-cf-purple-500",
  },
  {
    step: 3,
    ...
    icon: "🏪",
    accent: "from-cf-purple-500 to-fuchsia-500",
  },
]
