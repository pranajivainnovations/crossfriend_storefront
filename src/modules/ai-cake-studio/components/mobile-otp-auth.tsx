...
export default function MobileOtpAuth({ attemptsLimit = 3 }: Props) {
  ...
  return (
    ...
    <motion.div
      ...
      className="mt-4 rounded-2xl bg-gradient-to-r from-cf-purple-600 via-fuchsia-500 to-cf-purple-600 p-[3px] shadow-[0_10px_30px_rgba(123,47,247,0.28)]"
    >
        ...
        {step === "mobile" && (
          ...
          >
            <div className="flex gap-2">
              <span className="flex shrink-0 items-center rounded-xl border-2 border-cf-purple-200 bg-white px-3 py-3 text-sm font-semibold text-slate-500 select-none">
                +91
              </span>
              <input
                type="tel"
                ...
                className="min-w-0 flex-1 rounded-xl border-2 border-cf-purple-200 bg-white px-3 py-3 text-sm text-slate-800 placeholder:text-slate-400 focus:border-cf-purple-400 focus:outline-none focus:ring-2 focus:ring-cf-purple-200"
              />
              <button
                type="button"
                onClick={sendOtp}
                disabled={loading || mobile.length !== 10}
                className="shrink-0 whitespace-nowrap rounded-xl bg-gradient-to-r from-cf-purple-600 to-fuchsia-600 px-4 py-3 shadow-md shadow-cf-purple-300/50 text-sm font-bold text-white transition hover:from-cf-purple-700 hover:to-purple-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
                {loading ? (
          ...
          >
            ...
            <div className="flex gap-2">
              <input
                ...
                className="min-w-0 flex-1 rounded-xl border-2 border-cf-purple-200 bg-white px-3 py-3 text-sm tracking-[0.4em] text-slate-800 placeholder:tracking-normal placeholder:text-slate-400 focus:border-cf-purple-400 focus:outline-none focus:ring-2 focus:ring-cf-purple-200"
              />
              <button
                type="button"
                onClick={verifyOtp}
